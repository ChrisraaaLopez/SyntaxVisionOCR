...
def preprocess_for_ocr(pil_img: Image.Image, mode: str = "auto") -> Image.Image:
    ...
    if mode == "document":
        ...
        # mask_graphic_regions ahora está definida correctamente
...
# ══════════════════════════════════════════════════════════════════
#  HILO IA  —  v1.0: MULTIMODAL (imagen + texto OCR)
# ══════════════════════════════════════════════════════════════════
...
class AIImproveThread(QThread):
    ...
    def __init__(self, raw_text: str, api_key: str, provider: str,
        ...
        self.image_path = image_path  # v1.0: ruta de la imagen original
...
def generate_frontmatter(title: str = "Nota Importada", tags: list | None = None) -> str:
    ...
    return (
        ...
        f"time: {hora}\n"
        f"tags: [{tag_str}]\n"
        f"source: OCR - Syntax Vision v1.0\n"
        f"---\n\n"
    )
...
class SyntaxVision(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Syntax Vision  ·  OCR → PKM  ·  v1.0")
